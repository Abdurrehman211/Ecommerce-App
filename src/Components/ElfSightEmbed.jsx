            ...
            <div className="col-md-4 mb-4 mb-md-0">
              <div className="card">
                <div className="card-body py-4 mt-2">
                  ...
                  <p className="mb-2">
                    <i className="fas fa-quote-left pe-2"></i>Their customer support was good! They responded fast and were very helpful.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-4 mb-md-0">
              <div className="card">
                <div className="card-body py-4 mt-2">
                  ...
                  <p className="mb-2">
                    <i className="fas fa-quote-left pe-2"></i>I ordered 5 shirts from them and received them in no time. The customer support was awesome!
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-0">
              <div className="card">
                <div className="card-body py-4 mt-2">
                  ...
                  <p className="mb-2">
                    <i className="fas fa-quote-left pe-2"></i>I ordered five shirts from them, and they arrived quickly. The quality of the shirts was excellent.
                  </p>
                </div>
              </div>
            </div>
